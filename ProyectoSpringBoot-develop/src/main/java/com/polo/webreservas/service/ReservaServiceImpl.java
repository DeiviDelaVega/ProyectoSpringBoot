...
public class ReservaServiceImpl implements ReservaService {
    ...
    @Override
    public Page<Reserva> BuscarPorFechas(LocalDate fechaInicio, LocalDate fechaFin, Pageable pageable) {
        return reservaRepository.BuscarPorFechas(fechaInicio, fechaFin, pageable);
    }
}
